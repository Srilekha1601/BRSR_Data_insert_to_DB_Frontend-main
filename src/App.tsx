...
import BrsrUpload from "./pages/BrsrUpload";
import BrsrDataEntry from "./pages/BrsrDataEntry";
  ...
  <QueryClientProvider client={queryClient}>
    <ThemeProvider theme={theme}>
      ...
      <BrowserRouter>
        ...
        <Route path="/home" element={<LandingPage />} /> {/* ✅ NEW DEFAULT */}
          <Route path="/brsrxmlupload" element={<BrsrUpload />} />
          <Route path="/brsrdataentry" element={<BrsrDataEntry />} />
